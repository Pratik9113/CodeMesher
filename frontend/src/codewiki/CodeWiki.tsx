...
const CodeWiki = () => {
    ...
    if (sections === DUMMY_WIKI_DATA || sections.length === 0) {
        return (
            <div className="flex flex-col h-screen bg-[#0F1117]">
                <Navbar />
                <div className={`flex flex-1 items-center justify-center ${isDarkMode ? 'text-gray-100' : 'bg-gray-50 text-gray-900'} font-sans`}>
    ...
    return (
        <div className="flex flex-col h-screen overflow-hidden">
            <Navbar />
            <div className={`flex flex-1 ${isDarkMode ? 'bg-[#0F1117] text-gray-100' : 'bg-white text-gray-900'} font-sans antialiased overflow-hidden`}>
                <WikiSidebar
